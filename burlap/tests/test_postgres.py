...
class TestRequirePostgresDatabase(unittest.TestCase):
    ...
    @mock.patch('burlap.require.postgres._service_name')
    @mock.patch('burlap.require.postgres.restarted')
    @mock.patch('burlap.require.postgres.require_locale')
    @mock.patch('burlap.require.postgres.create_database')
    @mock.patch('burlap.require.postgres.run')
    @mock.patch('burlap.require.postgres.database_exists')
...
class TestRequirePostgresUser(unittest.TestCase):
    ...
    @mock.patch('burlap.require.postgres.create_user')
    @mock.patch('burlap.require.postgres.user_exists')
...
class TestPostgresDropDatabase(unittest.TestCase):
    ...
    def test_drop_database(self, _run_as_pg):
        ...
        from burlap.postgres import drop_database
