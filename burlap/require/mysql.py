...
# 
#     from burlap.deb import is_installed, preseed_package
...
# 
#     Extra arguments will be passed to :py:func:`burlap.mysql.create_user`.
# 
#     Example::
# 
...
# 
#     Extra arguments will be passed to :py:func:`burlap.mysql.create_database`.
# 
#     Example::
# 
#         from fabric.api import settings
