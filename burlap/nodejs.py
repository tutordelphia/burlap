...
from burlap.system import cpus, distrib_family
...
def install_package(package, version=None, local=False, npm='npm'):
    ...
    ::
        ...
        burlap.nodejs.install_package('express')

        # Install package locally
        burlap.nodejs.install_package('underscore', local=False)
...
def uninstall_package(package, version=None, local=False, npm='npm'):
    ...
    ::
        ...
        burlap.nodejs.uninstall_package('express')

        # Uninstall package locally
        burlap.nodejs.uninstall_package('underscore', local=False)
