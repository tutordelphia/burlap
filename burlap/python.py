...
from burlap.utils import abspath, download, run_as_root
...
def install_pip(python_cmd='python', use_sudo=True):
    ...
    ::
        ...
        if not burlap.python.is_pip_installed():
            burlap.python.install_pip()
...
def is_installed(package, pip_cmd='pip'):
    ...
    Example::
        ...
        from burlap.python import virtualenv
        import burlap

        with virtualenv('/path/to/venv'):
            burlap.python.install('Flask')
            assert burlap.python.is_installed('flask')
...
def install(packages, upgrade=False, download_cache=None, allow_external=None,
    ...
    Examples::
        ...
        burlap.python.install('package', use_sudo=True)

        # Install a list of packages
        burlap.python.install(['pkg1', 'pkg2'], use_sudo=True)
...
def install_requirements(filename, upgrade=False, download_cache=None,
    ...
    ::
        ...
        burlap.python.install_requirements('project/requirements.txt')
...
def create_virtualenv(directory, system_site_packages=False, venv_python=None,
    ...
    ::
        ...
        burlap.python.create_virtualenv('/path/to/venv')
